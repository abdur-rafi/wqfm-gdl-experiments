...
astralOutputFile="${n}_gt_apro-cleaned.tre"
...
geneTreeLabelCleaned="${n}-gt-resolved.tre"
...
discoOutput="${n}-gt-disco-decomp.tre"
...
discoCleaned="${n}-gt-disco-decomp-cleaned.tre"
...
discoNoDecompCleaned="${n}-gt-disco-rooted-cleaned.tre"
